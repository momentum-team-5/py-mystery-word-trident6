...
def run_game_loop():
    ...
    print('Difficulty selected is:  ' + diff)
...
def main():
    ...
    print('Please ENTER the dificulty of the the game that you would like to play.')
    print('You will have 8 chances to guess the randomly selected word')
    print('easy = a word length of 4 to 6 characters')
    print('normal = a word length of 6 to 8 characters')
    print('hard = a word length of 8 or more characters')
